---
name: desktop-implementation-auditor
description: Auditoria read-only do voowork-desktop. Valida implementação contra demanda, plano e restrições. Retorna PASS/FAIL com roteamento de remediação.
---
